...
class ChatbotMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<Map<String, dynamic>?>(
      future: isUserMessage ? _profileService.getProfile() : null,
          ...
          child: Row(
            ...
            children: [
              if (!isUserMessage) ...[
                CircleAvatar(
                  radius: 30.0,
                  backgroundImage: const AssetImage('assets/images/user_avatar1.png'),
                  backgroundColor: colorScheme.surface,
                  onBackgroundImageError: (exception, stackTrace) {
                    print('Erreur de chargement de l\'image chatbot_avatar.png: $exception');
                  },
