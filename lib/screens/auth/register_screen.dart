...
//                   Icons.lock,
//                   validator: (value) {
//                     if (value == null || value.isEmpty) return 'Veuillez créer un mot de passe';
...
//                     ),
//                     child: Text('Confirmer', style: textTheme.labelLarge?.copyWith(color: colorScheme.onPrimary)),
//                   ),
//                 ),
//                 const SizedBox(height: 20),
//                 Row(
      ...
      if (_passwordController.text == _confirmPasswordController.text) {
        try {
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('Inscription réussie ! Veuillez vérifier votre email avant de vous connecter.'),
              ),
            );
            Navigator.pushReplacementNamed(context, '/login');
          }
