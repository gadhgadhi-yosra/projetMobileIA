...
//     return Scaffold(
//       appBar: const CustomAppBar(title: 'Votre Panier'),
//       body: Column(
//         children: [
//           Expanded(
...
//                       children: [
//                         Icon(Icons.shopping_cart_outlined, size: 80, color: colorScheme.onBackground.withOpacity(0.6)),
...
//                         ElevatedButton.icon(
//                           onPressed: () {
//                             Navigator.of(context).pop(); // Retourne \u00e0 l'\u00e9cran pr\u00e9c\u00e9dent (Home)
//                           },
...
//                               child: Image.network(
//                                 product.imageUrl,
//                                 width: 70, // Taille l\u00e9g\u00e8rement augment\u00e9e
//                                 height: 70,
//                                 fit: BoxFit.cover,
...
//                                 color: colorScheme.primary, // Couleur d'accent pour le prix
//                                 fontWeight: FontWeight.bold,
//                               ),
//                             ),
//                             trailing: IconButton(
//                               icon: Icon(Icons.delete_forever, color: colorScheme.error), // Ic\u00f4ne de suppression plus explicite
//                               onPressed: () {
//                                 productProvider.removeFromCart(product);
//                                 ScaffoldMessenger.of(context).showSnackBar(
//                                   SnackBar(
//                                     content: Text('${product.name} retir\u00e9 du panier.'),
//                                     backgroundColor: colorScheme.error, // Couleur d'erreur du th\u00e8me
...
//               color: colorScheme.surface, // Utilise la couleur de surface du th\u00e8me
//               borderRadius: const BorderRadius.vertical(top: Radius.circular(20.0)), // Coins plus arrondis
//               boxShadow: [
//                 BoxShadow(
//                   color: Colors.black.withOpacity(0.3), // Ombre plus prononc\u00e9e
//                   spreadRadius: 3,
//                   blurRadius: 15,
...
//                       style: textTheme.headlineSmall?.copyWith(
//                         color: colorScheme.primary, // Couleur d'accent pour le total
//                         fontWeight: FontWeight.bold,
//                       ),
//                     ),
//                   ],
//                 ),
//                 const SizedBox(height: 20.0), // Espacement augment\u00e9
//                 ElevatedButton(
...
//                               backgroundColor: colorScheme.secondary, // Couleur d'info du th\u00e8me
//                               behavior: SnackBarBehavior.floating,
//                               shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
//                               margin: const EdgeInsets.all(10),
//                             ),
//                           );
//                           // Optionnel: vider le panier apr\u00e8s paiement simul\u00e9
