...
//     return Scaffold(
//       // Utilisation d'un CustomScrollView pour un effet de parallaxe sur l'image
//       body: CustomScrollView(
//         slivers: [
//           SliverAppBar(
//             expandedHeight: 300.0, // Hauteur de l'image \u00e9tendue
//             floating: false,
//             pinned: true,
...
//               ),
//               centerTitle: true,
//               background: Hero( // Ajout d'un Hero widget pour une belle transition d'image
//                 tag: product.id, // Assurez-vous que l'ID du produit est unique
//                 child: Image.network(
//                   product.imageUrl,
...
//                                 style: textTheme.titleMedium?.copyWith(
//                                   color: colorScheme.secondary, // Couleur d'accent secondaire
//                                   fontWeight: FontWeight.bold,
//                                 ),
//                               ),
//                             ],
